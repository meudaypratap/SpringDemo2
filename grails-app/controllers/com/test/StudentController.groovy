...
class StudentController {
    ...
    def list() {
        ...
        [studentInstanceList: studentService.getListData(), studentInstanceTotal: Student.count()]
    }
    ...
    def save() {
        ...
        if (!studentService.saveDataStudent(studentInstance)) {
    ...
    def show() {
        def studentInstance = studentService.showStudent(params.id as long)
        if (!studentInstance) {
    ...
    def update() {
        ...
        if (!studentService.saveDataUpdated(studentInstance)) {
            render(view: "edit", model: [studentInstance: studentInstance])
            return
        }
